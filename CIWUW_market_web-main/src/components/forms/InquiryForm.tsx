    ...
    const onSubmit = async (data: LicensingFormData) => {
       const formData = new FormData();
        ...
        try {
            ...
            const response = await fetch("/api/licensing-inquiry", {
            method: "POST",
            body: formData,
            });
            ...
            alert("Failed to submit. Please check your internet or contact support.");
        }
    };
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <input
                        ...
                        file:bg-[#146C43] file:text-white
                        hover:file:bg-[#0d5233]"
                    />
                    </div>
